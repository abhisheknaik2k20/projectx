    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          // Handle different states of the snapshot
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Incoming Call Text
                      Text(
                        hasCallData ? 'Incoming Call' : 'No Active Call',
                        style: TextStyle(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _CallButton(
                          ...
                          onPressed: hasCallData ? _handleCallAccept : null,
                        ),
                        // Reject Call Button
                        _CallButton(
                          icon: Icons.call_end,
                          backgroundColor: Colors.red,
                          onPressed: hasCallData ? _handleCallReject : null,
                        ),
                      ],
                    ),
                  ),
